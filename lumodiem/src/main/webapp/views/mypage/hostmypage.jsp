				...
				<div class="container">
					<div class="row d-flex">
						<div class="col-xl-8 py-5 px-md-5">
							...
							<div class="meta-wrap">
								<ul class="categories">
									<li><a href="<c:url value='/hostMypageStayKlass?account_no=${account.accountNo}'/>">승인 대기 클래스 조회 <span>(+)</span></a></li>
									<li><a href="<c:url value='/hostMypageApproveKlass?account_no=${account.accountNo}'/>">개설 클래스 목록 조회 <span>(+)</span></a></li>
